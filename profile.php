...
$retsult=BillingDetails::insertDetails($con, $agreement, $token, $userLoggedIn);

$retsult = $retsult && $user->setIsSubscribed(1);
...
<?php echo  $SubscriptionMessage; ?>
  ...
  if($user->getIsSubscribed()){
     echo "<h3>you are subscribed go to PayPal page to cencel.</h3>";
  }
  else{

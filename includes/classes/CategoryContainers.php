...
private function getCategoryHtml($sqlData, $title, $tvShow, $movies){
     ...
     elseif($tvShow){
        $entities= EntityProvider:: getTvShowEntities($this->con,$categoryId, 20);
     ...
     if(sizeof($entities)==0){
        ...
        foreach($entities as $entity){
            $entitiesHtml .= $previewProvider->creatEntityPreviewSquar($entity);
        } 
